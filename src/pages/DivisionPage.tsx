...
const DIVISIONS: DivisionConfig[] = [
  ...
  { id: 'div-farm',         label: 'Farm',          icon: '🚜', color: '#fb923c', description: 'Farm operations, equipment, and agricultural services',        services: ['Field Mowing','Land Clearing','Tractor Work','Hauling','Debris Removal','Stump Grinding','Right of Way'] },
