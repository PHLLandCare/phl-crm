import{c as e,d as t,n,o as r,t as i}from"./index-Fix011.js";var a=t(e(),1),o=i();
...
function ChecklistsPage(){
  ...
  var card={background:"var(--bg-surface)",border:"1px solid var(--bg-surface-2)",borderRadius:12,padding:16,marginBottom:10};
  var btn={padding:"8px 14px",border:"1px solid var(--bg-surface-2)",borderRadius:8,background:"rgba(255,255,255,.05)",color:"var(--text-primary)",cursor:"pointer",fontSize:12,fontWeight:600,fontFamily:"inherit"};
  var btnG={...btn,background:"#16a34a",border:"none"};
  var btnR={...btn,color:"#f87171",borderColor:"rgba(248,113,113,.3)"};
  var inp={padding:"10px 12px",background:"var(--bg-app)",border:"1px solid var(--bg-surface-2)",borderRadius:8,fontSize:13,color:"var(--text-primary)",fontFamily:"inherit",outline:"none",width:"100%",boxSizing:"border-box"};
  var lbl={fontSize:11,fontWeight:700,color:"var(--text-muted)",display:"block",marginBottom:5,textTransform:"uppercase",letterSpacing:"0.05em"};
  ...
  var mo={background:"var(--bg-surface)",border:"1px solid var(--bg-surface-2)",borderRadius:16,width:"100%",maxWidth:520,maxHeight:"90vh",overflow:"auto"};
  var mh_s={display:"flex",justifyContent:"space-between",alignItems:"center",padding:"18px 22px 14px",borderBottom:"1px solid var(--bg-surface-2)"};
  var mb_s={padding:"18px 22px",display:"flex",flexDirection:"column",gap:12};
  var mf_s={display:"flex",gap:8,justifyContent:"flex-end",padding:"14px 22px",borderTop:"1px solid var(--bg-surface-2)"};
  var sC={not_started:"var(--text-muted)",in_progress:"#f59e0b",completed:"#22c55e"};
  var sL={not_started:"Not started",in_progress:"In progress",completed:"Completed"};

  return(0,o.jsxs)(a.Fragment,{children:[
    toast&&(0,o.jsx)("div",{style:{position:"fixed",bottom:24,left:"50%",transform:"translateX(-50%)",background:"var(--bg-surface)",color:"#fff",padding:"12px 22px",borderRadius:10,fontSize:13,fontWeight:600,borderLeft:"4px solid #22c55e",zIndex:9999,boxShadow:"0 6px 24px rgba(0,0,0,.5)",whiteSpace:"nowrap"},children:toast}),
    ...
    (0,o.jsxs)("div",{style:{padding:"0 2rem 2rem",maxWidth:1100,margin:"0 auto"},children:[
      (0,o.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"1.5rem",flexWrap:"wrap",gap:12},children:[
        (0,o.jsxs)("div",{children:[
          (0,o.jsx)("h1",{style:{margin:0,fontSize:24,fontWeight:700,color:"var(--text-primary)"},children:"Checklists"}),
          (0,o.jsx)("p",{style:{margin:"4px 0 0",fontSize:13,color:"var(--text-muted)"},children:"Job quality checklists and inspection templates"})
        ]}),
      ...
      loading&&(0,o.jsx)("div",{style:{textAlign:"center",padding:"3rem",color:"var(--text-muted)"},children:"Loading..."}),

      !loading&&tab==="templates"&&(0,o.jsxs)("div",{children:[
        !templates.length&&(0,o.jsxs)("div",{style:{...card,textAlign:"center",padding:40,color:"var(--border-strong)"},children:[
        ...
        templates.map(tmpl=>(0,o.jsxs)("div",{style:card,children:[
          (0,o.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:12},children:[
            (0,o.jsxs)("div",{style:{flex:1},children:[
              (0,o.jsx)("div",{style:{fontWeight:700,color:"var(--text-primary)",fontSize:15,marginBottom:3},children:tmpl.name}),
              (0,o.jsx)("div",{style:{fontSize:12,color:"var(--text-muted)"},children:(tmpl.division||"All divisions")+" · "+(tmpl.items||[]).length+" items"})
            ]}),
          ...
          (0,o.jsx)("div",{style:{marginTop:8,display:"flex",flexWrap:"wrap",gap:4},children:[
            ...(tmpl.items||[]).slice(0,5).map((item,i)=>(0,o.jsx)("span",{style:{fontSize:11,padding:"2px 8px",background:"rgba(255,255,255,.06)",borderRadius:99,color:"var(--text-secondary)"},children:item.label||item},i)),
            (tmpl.items||[]).length>5&&(0,o.jsx)("span",{style:{fontSize:11,color:"var(--border-strong)"},children:"+"+((tmpl.items||[]).length-5)+" more"})
          ]})
        ]},tmpl.id))
      ]}),
      ...
      !loading&&tab==="active"&&(0,o.jsxs)("div",{children:[
        ...
        !filtered.length&&(0,o.jsxs)("div",{style:{...card,textAlign:"center",padding:40,color:"var(--border-strong)"},children:[
          (0,o.jsx)("div",{style:{fontSize:36,marginBottom:10},children:"✅"}),
        ...
        filtered.map(ac=>(0,o.jsxs)("div",{style:card,children:[
          (0,o.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:12},children:[
            (0,o.jsxs)("div",{style:{flex:1},children:[
              (0,o.jsx)("div",{style:{fontWeight:700,color:"var(--text-primary)",fontSize:14,marginBottom:2},children:ac.template_name||"Checklist"}),
              (0,o.jsx)("div",{style:{fontSize:12,color:"var(--text-muted)"},children:(ac.job_title||"No job")+(ac.client_name?" · "+ac.client_name:"")}),
              (0,o.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:8,marginTop:8},children:[
                ...
                (0,o.jsx)("span",{style:{fontSize:11,color:"var(--text-muted)"},children:(ac.items||[]).filter(i=>i.checked).length+"/"+(ac.items||[]).length}),
                (0,o.jsx)("span",{style:{fontSize:10,padding:"2px 8px",borderRadius:99,background:"rgba(255,255,255,.06)",color:sC[ac.status]||"var(--text-muted)",fontWeight:600},children:sL[ac.status]||ac.status})
              ]})
            ]}),
    ...
    showTmpl&&(0,o.jsx)("div",{style:ov,onClick:ev=>{if(ev.target===ev.currentTarget)setShowTmpl(false);},children:
      (0,o.jsxs)("div",{style:mo,children:[
        (0,o.jsxs)("div",{style:mh_s,children:[
          (0,o.jsx)("h2",{style:{margin:0,fontSize:17,fontWeight:700,color:"var(--text-primary)"},children:editId?"Edit Template":"New Template"}),
          (0,o.jsx)("button",{style:{background:"none",border:"none",color:"var(--text-muted)",fontSize:22,cursor:"pointer"},onClick:()=>setShowTmpl(false),children:"×"})
        ]}),
        (0,o.jsxs)("div",{style:mb_s,children:[
          ...
          (0,o.jsxs)("div",{children:[
            ...
            !tmplItems.length&&(0,o.jsx)("div",{style:{fontSize:12,color:"var(--border-strong)",padding:"6px 0"},children:"No items yet"}),
            tmplItems.map((item,idx)=>(0,o.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:8,padding:"7px 10px",background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.07)",borderRadius:7,marginBottom:4},children:[
              (0,o.jsx)("span",{style:{flex:1,fontSize:13,color:"var(--text-primary)"},children:item}),
    ...
    showAttach&&(0,o.jsx)("div",{style:ov,onClick:ev=>{if(ev.target===ev.currentTarget)setShowAttach(false);},children:
      (0,o.jsxs)("div",{style:{...mo,maxWidth:420},children:[
        (0,o.jsxs)("div",{style:mh_s,children:[
          (0,o.jsx)("h2",{style:{margin:0,fontSize:17,fontWeight:700,color:"var(--text-primary)"},children:"Attach to Job"}),
          (0,o.jsx)("button",{style:{background:"none",border:"none",color:"var(--text-muted)",fontSize:22,cursor:"pointer"},onClick:()=>setShowAttach(false),children:"×"})
        ]}),
        (0,o.jsxs)("div",{style:mb_s,children:[
          (0,o.jsxs)("div",{children:[
    ...
    showDetail&&detailCk&&(0,o.jsx)("div",{style:ov,onClick:ev=>{if(ev.target===ev.currentTarget)setShowDetail(false);},children:
      (0,o.jsxs)("div",{style:mo,children:[
        (0,o.jsxs)("div",{style:mh_s,children:[
          (0,o.jsxs)("div",{children:[
            (0,o.jsx)("h2",{style:{margin:0,fontSize:17,fontWeight:700,color:"var(--text-primary)"},children:detailCk.template_name||"Checklist"}),
            (0,o.jsx)("p",{style:{margin:"3px 0 0",fontSize:12,color:"var(--text-muted)"},children:(detailCk.job_title||"")+(detailCk.client_name?" · "+detailCk.client_name:"")})
          ]}),
          (0,o.jsx)("button",{style:{background:"none",border:"none",color:"var(--text-muted)",fontSize:22,cursor:"pointer"},onClick:()=>setShowDetail(false),children:"×"})
        ]}),
        (0,o.jsxs)("div",{style:mb_s,children:[
          (0,o.jsx)("div",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:6},children:detailItems.filter(i=>i.checked).length+" of "+detailItems.length+" completed"}),
          detailItems.map((item,idx)=>(0,o.jsxs)("label",{style:{display:"flex",alignItems:"center",gap:10,padding:"10px 12px",background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.07)",borderRadius:8,marginBottom:5,cursor:"pointer"},children:[
            ...
            (0,o.jsx)("span",{style:{fontSize:13,color:item.checked?"var(--text-muted)":"var(--text-primary)",textDecoration:item.checked?"line-through":"none"},children:item.label||item})
          ]},idx)),
